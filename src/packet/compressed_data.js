...
import { getSyncMessageGrammarValidator } from './grammar';
...
class CompressedDataPacket {
  ...
  async decompress(config = defaultConfig) {
    ...
    this.packets = await PacketList.fromBinary(await decompressionFn(this.compressed), allowedPackets, config, getSyncMessageGrammarValidator());
  }
